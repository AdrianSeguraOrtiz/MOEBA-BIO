...
public class SpecificCrossover implements CrossoverOperator<IntegerSolution> {
    private double crossoverProbability;
    private int numParents;
	private int numOffspring;   

    public SpecificCrossover(double crossoverProbability, int numberOfParents, int numberOfOffspring) {
